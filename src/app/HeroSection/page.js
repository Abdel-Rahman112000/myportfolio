...
export default function HeroSection() {
    return (
        <section className=' overflow-auto w-full h-screen bg-banner-bg bg-no-repeat bg-center bg-cover'>
            <Transition />
            <div className=" relative container mx-auto mt-24 py-4 px-8 grid grid-cols-2 sm:grid-cols-12">
                <div
                    ...
                    >
                        ...
                        <Link target='_blank' href={'https://drive.google.com/file/d/1HxLJ_dS5etk4Wt6eO0LW2k270OOLbNsN/view?usp=drive_link'}>
                        ...
                        <div className='socials flex mt-3 gap-14 ml-5 justify-center sm:justify-start  '>
                            ...
                            <Link href={"https://www.facebook.com/abdelrahman.aboaitta"} target='_blank'>
